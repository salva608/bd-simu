...
Generación de estadísticas en consola.
...
Conversión de valores numéricos usando parseInt y parseFloat.
...
Se registran múltiples citas asociadas correctamente.
...
Uso de transacciones para limpieza inicial.

Separación de configuración (env, postgres, mongodb).

Proceso de migración idempotente.
